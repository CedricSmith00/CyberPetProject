...
feed.addEventListener("click", () => {
    hungervalue = Math.min(hungervalue + 10, 100) // Increase hunger level by 10, max 100
    hunger.value = hungervalue 
    increaseHealth(5) // Increase health by 5 when feeding
})

sleep.addEventListener("click", () => {
    tirednessvalue = Math.min(tirednessvalue + 10, 100) // Increase tiredness level by 10, max 100
    tiredness.value = tirednessvalue 
    increaseHealth(5) // Increase health by 5 when sleeping
})

drink.addEventListener("click", () => {
    thirstvalue = Math.min(thirstvalue + 10, 100) // Increase thirst level by 10, max 100
    thirst.value = thirstvalue 
    increaseHealth(4) // Increase health by 5 when drinking
})
...
hunt.addEventListener("click", () => {
    ...
    thirstvalue = Math.max(thirstvalue - 5, 0); // Decrease thirst by 3
